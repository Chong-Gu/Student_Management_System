            ...
            <div class="content">
                ...
                <form method="POST" enctype="multipart/form-data" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
                    ...
                    <label>ID </label><br>
                        ...
                        ?>
                        <input type="text" class="input3" name="rno" value="<?php echo $no;?>" readonly ><br>
                        <label>Student Name </label><br>
                        <input type="text" class="input3" name="name"><br>
                        <label> Father Name </label><br>
                        <input type="text" class="input3" name="fname"><br>
                        ...
                        <label>Gender</label>
                        <select name="gen" class="input3" required>
                        ...
                        <input type="text" class="input3" maxlength="10" name="pho"><br>
                    </div>
                    ...
                    <div class="rbox">
                        <label>Parent's Mail Id </label><br>
                            ...
                            <textarea row="5" name="addr"></textarea><br><br>
                            <label>Class <label>
                            ...
                            <?php 
                                $s = "select DISTINCT(CSEC) from class";
                                $r = $db->query($s);
                                if($r->num_rows>0){
                                    echo "<option value=''>Select</option>";
                                    while($ro=$r->fetch_assoc()){
                            ...
                            <input type="file" class="input3" name="img" required><br><br>
