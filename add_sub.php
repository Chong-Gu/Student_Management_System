...
<html>
    ...
    <body>
        ...
        <div id="section">
            ...
            <h3 class = "text">Welcom <?php echo $_SESSION["ANAME"];?></h3><br><hr><br>
            <div class="content1">
                ...
                <?php
                    if(isset($_POST["submit"]))
                    {
                        ...
                        if($db->query($sq))
                        {
                            echo "<div class='success'>Inset Success..</div>";
                        }
                        else
                        {
                            echo "<div class='error'>Inset Failed..</div>";
                        }
                    }
                ?>
            ...
            <div class="tbox">
                <h3 style="margin-top:30px;">Subkect Details</h3><br>
                <?php
                    if(isset($_GET["mes"]))
                    {
