			...
			<div class="content">
				...
				<form method="post" action="<?php echo $_SERVER["REQUEST_URI"];?>">
					<div class="lbox">
						...
						<input type="text" value="<?php echo $regno;?>" class="input3" name="regno" readonly><br>
						
						<label>Class</label><br>
						<input type="text" value="<?php echo $class ?>" class="input3" name="class" readonly><br>
					
						<label> Select Term</label><br>
						<select name="etype" class="input3" required>
					...
					<div class="rbox">
						<label>Subject</label><br>
							...
							<label >Mark :</label><br>
							<input class="input3" name="mark"  id="mark" type="mark" required><br>    							
					</div>
